...
export class DayOne {
  ...
  attached() {
    ...
    this.mainAnswerAnswer = this.getAnswer(mainAnswer);
    ...
    this.partTwoAnswer = this.getAnswerTwo(mainAnswer);
  }
